$(document).ready(function(){
    ...
    function rellenar_laboratorios(){
        ...
        $.post('../controlador/laboratoriocontroller.php',{funcion: funcion},(response)=>{
    ...
    function rellenar_proveedores(){
        ...
        $.post('../controlador/ProveedorController.php',{funcion: funcion},(response)=>{
    ...
    function rellenar_tipos(){
        ...
        $.post('../controlador/tipocontroller.php',{funcion: funcion},(response) =>{
    ...
    function rellenar_presentaciones(){
        ...
        $.post('../controlador/presentacioncontroller.php',{funcion: funcion},(response)=>{
    ...
    $('#form-crear-producto').submit(e=>{
        ...
        $.post('../controlador/ProductoController.php', {funcion, id, nombre, descripcion, adicional, precio, laboratorio, tipo, presentacion},(response)=>{
            if(response == 'add'){
                $('#add').hide('slow');
                $('#add').show(1000);
                $('#add').hide(2000);
            ...
            <div class="card text-bg-light">
              ...
              <div class="card-footer">
                <div class="text-right">
                  ...
                  <button class="editar btn-sm btn-success" type="buttton" data-toggle="modal" data-target="#crearproducto">
                      <i class="fas fa-pencil-alt"></i>
                  </button>
                  <button class="lote btn btn-sm btn-primary" type="buttton" data-toggle="modal" data-target="#crearlote">
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
              ...
              swalWithBootstrapButtons.fire({
                title: "Eliminado!",
                text: 'El producto '+nombre+' sido eliminado correctamente.',
                icon: "success"
