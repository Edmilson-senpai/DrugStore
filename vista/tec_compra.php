  ...
  <div class="content-wrapper" style="min-height: 1202.92px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Sección de venta</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <div class="card-body p-0">
                        <header>
                            ...
                            <div class="datos_cp">
                                ...
                                <div class="form-group row">
                                    <span>DNI: </span>
                                    <div class="input-group-append col-md-6">
                                        <input type="number" class="form-control" id="dni" min="0" max="99999999" placeholder="Ingresa DNI">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span>Vendedor: </span>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-2">
                                <a href="../vista/tec_catalogo.php" class="btn btn-primary btn-block">Seguir comprando</a>
                            </div>
