...
class VentaProducto {
    ...
    function ver($id){
        $sql="SELECT precio,cantidad,producto.nombre AS producto,descripcion,adicional, laboratorio.nombre AS laboratorio, presentacion.nombre AS presentacion, tipo_producto.nombre AS tipo, subtotal
        FROM venta_producto
